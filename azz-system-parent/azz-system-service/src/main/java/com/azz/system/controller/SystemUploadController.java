...
public class SystemUploadController {
	...
	public JsonResult<String> imageUpload(@RequestParam("bucketname") String bucketname, String filename,String suffix, String filedata, Integer plattype, Integer imagetype) throws FileNotFoundException {
