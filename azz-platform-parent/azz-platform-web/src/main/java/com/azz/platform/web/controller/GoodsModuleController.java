...
public class GoodsModuleController {
	...
	JsonResult<Pagination<GoodsModuleInfo>> getGoodModuleInfoList(SearchGoodsModuleParam param) {
	...
	JsonResult<GoodsModuleInfo> getGoodModuleInfo(String moduleCode) {
