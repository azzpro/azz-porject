...
public class ClientUser implements Serializable {
    ...
    /**
     * 是否为企业认证者 1是 0否<br/>
     * 返回值对应的表列名 client_user.is_enterprise_authenticator
     *
     * @return 返回值对应 client_user.is_enterprise_authenticator
     *
     * @mbg.generated
     */
    ...
    /**
     * 是否为企业认证者 1是 0否<br/>
     * client_user.is_enterprise_authenticator
     *
     * @param isEnterpriseAuthenticator 值对应 client_user.is_enterprise_authenticator
     *
     * @mbg.generated
     */
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getIsEnterpriseAuthenticator() == null ? other.getIsEnterpriseAuthenticator() == null : this.getIsEnterpriseAuthenticator().equals(other.getIsEnterpriseAuthenticator()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getIsEnterpriseAuthenticator() == null) ? 0 : getIsEnterpriseAuthenticator().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", isEnterpriseAuthenticator=").append(isEnterpriseAuthenticator);
