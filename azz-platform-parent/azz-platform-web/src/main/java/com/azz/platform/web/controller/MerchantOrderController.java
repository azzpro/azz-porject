...
public class MerchantOrderController {
	...
	public JsonResult<OrderDetail> getPlatformMerchantOrderDetail(SearchOrderDetailParam param){
		return platformMerchantOrderService.getPlatformMerchantOrderDetail(param);
	}
