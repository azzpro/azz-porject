 ...
 * <PRE>
 * 金额转为大写，只精确到厘
 * 如输入123.555，将输出：壹佰贰拾叁元伍角伍分伍厘
 * </PRE>
 * 
 * @version 1.0
 * @author 张泽豪（13826587335） 2014-8-5 上午9:45:43
 */
public final class RmbUtil {
    ...
    public static String toBigAmt(double amount) {
        ...
        /*
         * if(dotBig.length() == 0) return intBig +"元整"; else return intBig + "元" + dotBig;
         */
    }
    ...
    public static void main(String[] args) {
        System.out.println(RmbUtil.toBigAmt(123.555));
    }
}
